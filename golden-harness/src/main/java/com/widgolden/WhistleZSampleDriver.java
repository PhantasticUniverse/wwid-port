...
/**
 * Dumps impedance (Z) values for one representative Whistle combo:
 * SamplePVC-Whistle + SamplePVC-tuning.
 *
 * For each fingering in the tuning, computes Z at the target frequency
 * and records the real and imaginary parts.
 *
 * Uses WhistleCalculator, matching the wiring in WhistleStudyModel.
 *
 * Output: golden/expected/WH-ZSAMPLE/z_samples.json
 */
public class WhistleZSampleDriver {

    private static final String ORACLE_BASE = "../oracle/v2.6.0";
    private static final String OUTPUT_DIR = "../golden/expected/WH-ZSAMPLE";

    private static final String INSTRUMENT_FILE = "SamplePVC-Whistle.xml";
    private static final String TUNING_FILE = "SamplePVC-tuning.xml";
