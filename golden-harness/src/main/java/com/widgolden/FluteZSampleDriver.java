...
/**
 * Dumps impedance (Z) values for one representative Flute combo:
 * SamplePVC-Flute + D4-Equal.
 *
 * For each fingering in the tuning, computes Z at the target frequency
 * and records the real and imaginary parts.
 *
 * Uses FluteCalculator, matching the wiring in FluteStudyModel.
 *
 * Output: golden/expected/FL-ZSAMPLE/z_samples.json
 */
public class FluteZSampleDriver {

    private static final String ORACLE_BASE = "../oracle/v2.6.0";
    private static final String OUTPUT_DIR = "../golden/expected/FL-ZSAMPLE";

    private static final String INSTRUMENT_FILE = "SamplePVC-Flute.xml";
    private static final String TUNING_FILE = "D4-Equal.xml";
    ...
    public static void main(String[] args) throws Exception {
        ...
        FluteCalculator calculator = new FluteCalculator();
